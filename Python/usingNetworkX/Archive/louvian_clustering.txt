#!/usr/bin/python
#Program using NetworkX and finaly displaying louvian clusters. Better graphical effect achivied using Cytoscape. Program needs tidy up.
...
infile2 = "%s/output/bigramsFG/improved_15Jan2014/pfamDomCount_inFG_withUniquePfamNo.txt" % (workDir1)



infile3 = "%s/heteroBigramswithWeights_orderNoMatter.txt" % (workDir1)



outfile = "%s/output/fg_bigramsNetwork/bigramOrderNoMatter/heteroBigramsNetwork/increasedVirulencePfamDomains_copyJan2016.txt" % (workDir1)



outfile1 ="%s/output/fg_bigramsNetwork/bigramOrderNoMatter/heteroBigramsNetwork/connectedComponentsInfo_copyJan2016.txt" % (workDir1)
